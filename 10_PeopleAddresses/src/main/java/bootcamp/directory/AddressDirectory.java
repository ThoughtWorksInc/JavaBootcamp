...
public class AddressDirectory {
    ...
    public AddressDirectory(final List<PersonAddressPair> addressList) {
        // convert addressList to a HashMap assigned to directory.
        directory = new HashMap<>();
//        With iterator
//        Iterator iterator = addressList.iterator();
//        while (iterator.hasNext()) {
//            directory.put(((PersonAddressPair) (iterator.next())).getPerson(),((PersonAddressPair) (iterator.next())).getAddress());
//        }
        for (PersonAddressPair pap: addressList) {
            directory.put(pap.getPerson(), pap.getAddress());
        }
    }
    ...
    public boolean hasPerson(Person person) {
        if (directory.keySet().contains(person)) return true;
        return false;
    }
